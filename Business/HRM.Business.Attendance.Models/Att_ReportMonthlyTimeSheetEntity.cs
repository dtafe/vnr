...
{
    public class Att_ReportMonthlyTimeSheetEntity : HRMBaseModel
    {
       ...
       // public double AnlDayAvailable { get; set; }
        ...
        public partial class FieldNames
        {
            ...
            public const string CodeCenter = "CodeCenter";
    ...
    public class Att_ReportMonthlyTimeSheetV2Entity : HRMBaseModel
    {
        [DisplayName(ConstantDisplay.HRM_Attendance_CodeEmp)]
        public string CodeEmp { get; set; }
        public string ProfileName { get; set; }
        ...
        public double TotalPregnancy { get; set; }
        ...
        public partial class FieldNames
        {
            ...
            public const string ResignedDate = "ResignedDate";
            ...
            public const string UnPaidLeave = "UnPaidLeave";
            public const string SickDayTaken = "SickDayTaken";
            public const string TotalPregnancy = "TotalPregnancy";
