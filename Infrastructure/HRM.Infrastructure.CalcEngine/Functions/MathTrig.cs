...
namespace CalcEngine
{
    static class MathTrig
    {
...
#endif
        //static object CONCATENATE(List<Expression> p)
        //{
        //    try
        //    {
        ...
        static object ADDMONTH(List<Expression> p)
        {
            try
            {
                DateTime Date = (DateTime)p[0];
                return Date.AddMonths((int)p[1]);
            }
            catch
            {
                return -1;
        ...
        static object ADDDAY(List<Expression> p)
        {
            try
            {
                DateTime Date = (DateTime)p[0];
                return Date.AddDays((int)p[1]);
            }
            catch
            {
                return -1;
        ...
        static object ADDYEAR(List<Expression> p)
        {
            try
            {
                DateTime Date = (DateTime)p[0];
                return Date.AddYears((int)p[1]);
            }
            catch
            {
                return -1;
        ...
        static object EOMONTH(List<Expression> p)
        {
            try
            {
        ...
        static object DATE(List<Expression> p)
        {
            try
            {
                ...
                return new DateTime((int)p[0], (int)p[1], (int)p[2]);
            }
            catch
            {
                return -1;
        ...
        static object DAY(List<Expression> p)
        {
            try
            {
                DateTime date = DateTime.Parse(p[0]);
                return date.Day;
            }
            catch
            {
