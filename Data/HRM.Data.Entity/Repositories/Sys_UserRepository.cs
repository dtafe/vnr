...
namespace HRM.Data.Entity.Repositories
{
    public class Sys_UserRepository : CustomBaseRepository<Sys_UserInfo>
    {
        ...
        {
            var result = this.DbSet.FirstOrDefault(p => p.UserLogin.ToLower() == userName.ToLower() && p.Password == password && p.IsDelete != true);
            return result.CopyData<Sys_UserInfoEntity>();
        }
