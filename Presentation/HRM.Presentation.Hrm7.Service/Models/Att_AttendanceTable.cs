...
namespace HRM.Presentation.Hrm7.Service.Models
{
    ...
    public partial class Att_AttendanceTable
    {
        public Att_AttendanceTable()
        {
            this.Att_AdvanceTableItem = new HashSet<Att_AdvanceTableItem>();
        ...
        public virtual ICollection<Att_AdvanceTableItem> Att_AdvanceTableItem { get; set; }
