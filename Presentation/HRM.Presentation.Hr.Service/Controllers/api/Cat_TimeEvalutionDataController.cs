...
{
    public class Cat_TimeEvalutionDataController : ApiController
    {
        #region UserLogin
        ...
        [System.Web.Mvc.RouteAttribute("api/Cat_TimeEvalutionData")]
        public Cat_NameEntityModel Post([Bind]Cat_NameEntityModel model)
       {
            #region Validate
            string message = string.Empty;
            var checkValidate = HRM.Business.Main.Domain.ValidatorService.OnValidateData<Cat_NameEntityModel>(model, "Cat_TimeEvalutionData", "Cat_NameEntity", ref message);
            if (!checkValidate)
            {
