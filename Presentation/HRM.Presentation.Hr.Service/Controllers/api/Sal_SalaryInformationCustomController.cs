...
{
    public class Sal_SalaryInformationCustomController : ApiController
    {
        #region UserLogin
        ...
        public Sal_SalaryInformationModel GetById(Guid id)
        {
            ...
            var entity = service.GetByIdUseStore<Sal_SalaryInformationEntity>(id, ConstantSql.hrm_sal_sp_get_Sal_SalaryInfomationByProfileId, ref status);
            if (entity!=null)
            {
