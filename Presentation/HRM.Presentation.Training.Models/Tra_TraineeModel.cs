...
{
    public class Tra_TraineeModel : BaseViewModel
    {
    ...
    public class Tra_TraineeSearchModel
    {
        [DisplayName(ConstantDisplay.HRM_Tra_Trainee_ProfileID)]
        public string ProfileName { get; set; }
    ...
    public class Tra_TraineeSearchModel1
    {
        [DisplayName(ConstantDisplay.HRM_Tra_Trainee_ClassID)]
    ...
    public class Tra_TraineeForAddSearchModel
    {
        [DisplayName(ConstantDisplay.HRM_Att_Report_CodeEmp)]
        public string CodeEmp { get; set; }
        [DisplayName(ConstantDisplay.HRM_Tra_Trainee_ProfileID)]
    ...
    public class Tra_AnalysisTrainingSearchModel
    {
        [DisplayName(ConstantDisplay.HRM_Att_Report_CodeEmp)]
        public string CodeEmp { get; set; }
        [DisplayName(ConstantDisplay.HRM_Tra_Trainee_ProfileID)]
