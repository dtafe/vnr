...
namespace HRM.Presentation.Main.Controllers
{
    ...
    public class Hre_ProfileProbationController : MainBaseController
    {
        ...
        {
            return RemoveOrDeleteAndReturn<Hre_ProfileModel>(_hrm_Hr_Service, "api/Hre_Profile/", string.Join(",", selectedIds), ConstantPermission.Hre_ProfileProbation, DeleteType.Remove.ToString());
