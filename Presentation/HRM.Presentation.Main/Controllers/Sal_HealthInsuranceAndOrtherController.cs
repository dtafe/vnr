...
{
    public class Sal_HealthInsuranceAndOrtherController : MainBaseController
    {
        ...
        public ActionResult Sal_HealthInsuranceAndOrtherInfo(string id)
        {
        ...
        //    {
        //        var id1 = Common.ConvertToGuid(id);
        //        var service = new RestServiceClient<Sal_UnusualAllowanceModel>();
        //        service.SetCookies(Request.Cookies, _hrm_Hr_Service);
        //        var modelResult = service.Get(_hrm_Hr_Service, "api/Sal_UnusualAllowance/", id1);
