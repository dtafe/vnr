...
{
    public class Cat_SupplierController : MainBaseController
    {
        ...
        public ActionResult Cat_SupplierInfo(string id)
        {
            ...
            if (!string.IsNullOrEmpty(id))
            {
                ...
                var service = new RestServiceClient<Cat_SupplierModel>(UserLogin);
                service.SetCookies(Request.Cookies, _hrm_Hr_Service);
                var modelResult = service.Get(_hrm_Hr_Service, "api/Cat_Supplier/", id1);
        ...
        public ActionResult RemoveSelected(List<Guid> selectedIds)
        {
            ...
            var user = new List<Cat_SupplierModel>();
            if (selectedIds != null)
            {
                //var ids = selectedIds
                ...
                {
                    service.Delete(_hrm_Hr_Service, "api/Cat_Supplier/", id);
                }
            }
            return Json("");
        }
