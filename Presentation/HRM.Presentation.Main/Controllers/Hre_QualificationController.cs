...
{
    public class Hre_QualificationController : MainBaseController
    {
        ...
        /// <returns></returns>
        public ActionResult Add([Bind] Hre_QualificationModel model)
        {
        ...
        {
            return RemoveOrDeleteAndReturn<Hre_ProfileQualificationModel>(_hrm_Hr_Service, "api/Hre_Qualification/", selectedIds, 
        ...
        [HttpPost]
        public ActionResult Edit([DataSourceRequest] DataSourceRequest request, Hre_QualificationModel Qualification)
        {
        ...
        public ActionResult QualificationInfo(string id)
        {
            ...
            if (!string.IsNullOrEmpty(id))
            {
                ...
                var service = new RestServiceClient<Hre_ProfileQualificationModel>(UserLogin);
                service.SetCookies(Request.Cookies, _hrm_Hr_Service);
                var result = service.Get(_hrm_Hr_Service, "api/Hre_ProfileQualification/", id1);
