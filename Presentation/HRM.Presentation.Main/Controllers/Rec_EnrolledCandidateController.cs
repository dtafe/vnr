...
{
    public class Rec_EnrolledCandidateController : MainBaseController
    {
        ...
        public ActionResult CreateRecReasonDeny(string selectedItems)
        {
        ...
        public ActionResult CorfirmBlackList_Enrolled(string selectedItems)
        {
            if (!string.IsNullOrEmpty(selectedItems))
            {
                ViewData["lstIDs"] = selectedItems;
