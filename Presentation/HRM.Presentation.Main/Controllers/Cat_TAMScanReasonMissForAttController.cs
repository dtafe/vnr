...
namespace HRM.Presentation.Main.Web.Controllers
{
    ...
    public class Cat_TAMScanReasonMissForAttController : MainBaseController
    {
        ...
        public ActionResult Cat_TAMScanReasonMissForAttInfo(string id)
        {
            ...
            if (!string.IsNullOrEmpty(id))
            {
                ...
                var result = service.Get(_hrm_Hr_Service, "api/Cat_TAMScanReasonMissForAtt/", id1);
                return View(result);
            }
            else
            {
        ...
        public ActionResult Remove(Guid id)
        {
            ...
            var service = new RestServiceClient<Cat_TAMScanReasonMissModel>(UserLogin);
            service.SetCookies(this.Request.Cookies, _hrm_Hr_Service);
            var result = service.Remove(_hrm_Hr_Service, "api/Cat_TAMScanReasonMissForAtt/", id);
            return Json(result);
        }
        ...
        public ActionResult RemoveSelected(string selectedIds)
        {
            ...
            return RemoveOrDeleteAndReturn<Cat_TAMScanReasonMissModel>(_hrm_Hr_Service, "api/Cat_TAMScanReasonMissForAtt/", selectedIds, ConstantPermission.Cat_TAMScanReasonMissForAtt, DeleteType.Remove.ToString());
        }
