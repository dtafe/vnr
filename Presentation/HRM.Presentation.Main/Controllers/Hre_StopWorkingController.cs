...
namespace HRM.Presentation.Main.Controllers
{
    ...
    public class Hre_StopWorkingController : MainBaseController
    {
        ...
        public ActionResult StopworkAddInfor(string id)
        {
        ...
        {
            return RemoveOrDeleteAndReturn<Hre_StopWorkingModel>(_hrm_Hr_Service, "api/Hre_StopWorking/",string.Join(",",selectedIds), ConstantPermission.Hre_StopWorking, DeleteType.Remove.ToString());
        }
