...
{
    public class Rec_CandidateController : MainBaseController
    {
        ...
        public ActionResult CorfirmBlackListReason(string selectedItems)
        {
        ...
        public ActionResult RecCandidateHistoryInfo(string id, Guid? CandidateID)
        {
            ...
            if (!string.IsNullOrEmpty(id))
            {
                ...
                service.SetCookies(Request.Cookies, _Hrm_Hre_Service);
                var modelResult = service.Get(_Hrm_Hre_Service, "api/Hre_CandidateHistory/", id1);
