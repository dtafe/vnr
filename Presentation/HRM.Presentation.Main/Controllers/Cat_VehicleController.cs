...
{
    public class Cat_VehicleController : MainBaseController
    {
        private readonly string _hrm_Hr_Service = ConstantPathWeb.Hrm_Hre_Service;
        //
        // GET: /Cat_ListVehicle_/
        public ActionResult Index()
        {
            return View();
        }
         
        public ActionResult Cat_VehicleInfo(string id)
        {
            ...
            else
            {
                ...
                modelResult.VehicleName = modelResult.NameEntityName;
