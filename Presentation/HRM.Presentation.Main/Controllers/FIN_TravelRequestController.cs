...
{
    public class FIN_TravelRequestController : MainBaseController
    {
        ...
        public ActionResult Create(FIN_TravelRequestModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                var result = service.Put(_hrm_Hr_Service, "api/FIN_TravelRequest/", model);
        ...
        public ActionResult CreatePayment(Guid? id)
        {
            ...
            var service = new RestServiceClient<FIN_ClaimModel>(UserLogin);
            service.SetCookies(this.Request.Cookies, _hrm_Hr_Service);
            var result = service.Get(_hrm_Hr_Service, "api/FIN_TravelRequest/", id.Value);
            return View(result);
        }
        [HttpPost]
        public ActionResult Edit([DataSourceRequest] DataSourceRequest request, FIN_TravelRequestModel Contract)
        {
            ...
            if (ModelState.IsValid)
            {
                var service = new RestServiceClient<FIN_TravelRequestModel>(UserLogin);
                service.SetCookies(this.Request.Cookies, _hrm_Hr_Service);
                var result = service.Put(_hrm_Hr_Service, "api/FIN_TravelRequest/", Contract);
        ...
        {
            return RemoveOrDeleteAndReturn<FIN_TravelRequestModel>(_hrm_Hr_Service, "api/FIN_TravelRequest/", selectedIds, ConstantPermission.Hre_ProfileAll, DeleteType.Remove.ToString());
        }
