...
namespace HRM.Presentation.Main.Controllers
{
    ...
    public class Hre_ProfileQuitController : MainBaseController
    {
        ...
        {
            return RemoveOrDeleteAndReturn<Hre_ProfileModel>(_hrm_Hr_Service, "api/Hre_Profile/", selectedIds, ConstantPermission.Hre_ProfileQuit, DeleteType.Remove.ToString());
        ...
        public ActionResult Hre_SettlementInfo()
        {
            return View();
        }
    }
