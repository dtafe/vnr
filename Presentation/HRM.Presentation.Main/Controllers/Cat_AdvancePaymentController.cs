...
{
    public class Cat_AdvancePaymentController : MainBaseController
    {
        ...
        public ActionResult GetAll([DataSourceRequest] DataSourceRequest request)
        {
            ...
            var result = service.Get(_hrm_Hr_Service, "api/Cat_AdvancePayment/");
        ...
        public ActionResult Add([Bind] CatElementModel model)
        {
            ...
            var result = service.Put(_hrm_Hr_Service, "api/Cat_AdvancePayment/", model);
            return Json(result);
        }
        ...
        public ActionResult Remove(string id)
        {
            ...
            var service = new RestServiceClient<CatElementModel>(UserLogin);
            service.SetCookies(this.Request.Cookies, _hrm_Hr_Service);
            var result = service.Delete(_hrm_Hr_Service, "api/Cat_AdvancePayment/", id);
            return Json(result);
        }
        ...
        public ActionResult Edit(string id)
        {
            ...
            var service = new RestServiceClient<CatElementModel>(UserLogin);
            service.SetCookies(this.Request.Cookies, _hrm_Hr_Service);
            var result = service.Get(_hrm_Hr_Service, "api/Cat_AdvancePayment/", id1);
            return View(result);
        }
        [HttpPost]
        public ActionResult Edit([DataSourceRequest] DataSourceRequest request, CatElementModel CatElement)
        {
            ...
            if (ModelState.IsValid)
            {
                var service = new RestServiceClient<CatElementModel>(UserLogin);
                service.SetCookies(this.Request.Cookies, _hrm_Hr_Service);
                var result = service.Put(_hrm_Hr_Service, "api/Cat_AdvancePayment/", CatElement);
        ...
        {
            return RemoveOrDeleteAndReturn<CatElementModel>(_hrm_Hr_Service, "api/Cat_AdvancePayment/", selectedIds, ConstantPermission.Cat_Element, DeleteType.Remove.ToString());
