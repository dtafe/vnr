...
{
    public class Cat_SickController : MainBaseController
    {
        ...
        public ActionResult CatSickInfo(string id)
        {
        ...
        {
            return RemoveOrDeleteAndReturn<Cat_NameEntityModel>(_hrm_Hr_Service, "api/Cat_LevelGeneral/", selectedIds, ConstantPermission.Cat_Sick, DeleteType.Remove.ToString());
        }
    }
}