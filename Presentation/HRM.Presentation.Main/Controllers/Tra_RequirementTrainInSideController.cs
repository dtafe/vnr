...
{
    public class Tra_RequirementTrainInSideController : MainBaseController
    {
        ...
        {
            return RemoveOrDeleteAndReturn<Tra_RequirementTrainModel>(_hrm_Hr_Service, "api/Tra_RequirementTrain/", selectedIds, ConstantPermission.Tra_RequirementTrainInSide, DeleteType.Remove.ToString());
        }
