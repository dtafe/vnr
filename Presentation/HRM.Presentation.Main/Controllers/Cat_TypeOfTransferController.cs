...
{
    public class Cat_TypeOfTransferController : MainBaseController
    {
        ...
        public ActionResult CatTypeOfTransferInfo(string id)
        {
        ...
        {
            return RemoveOrDeleteAndReturn<Cat_NameEntityModel>(_hrm_Hr_Service, "api/Cat_NameEntity/", selectedIds, ConstantPermission.Cat_TypeOfTransfer, DeleteType.Remove.ToString());
        }
    }
}