...
{
    public class Cat_OwnerController : MainBaseController
    {
        ...
        public ActionResult Cat_OwnerInfo(string id) 
        {

            if (!string.IsNullOrEmpty(id))
            {
                var id1 = Common.ConvertToGuid(id);
                var service = new RestServiceClient<Cat_OwnerModel>(UserLogin);
                service.SetCookies(Request.Cookies, _hrm_Hr_Service);
                var modelResult = service.Get(_hrm_Hr_Service, "api/Cat_Owner/", id1);
        ...
        //    service.SetCookies(Request.Cookies, _hrm_Hr_Service);
        //    var result = service.Get(_hrm_Hr_Service, "api/Cat_OwnerController/");
        ...
        public ActionResult RemoveSelected(List<Guid> selectedIds)
        {
            ...
            var user = new List<Cat_OwnerModel>();
            if (selectedIds != null)
            {
                ...
                {
                    service.Delete(_hrm_Hr_Service, "api/Cat_Owner/", id);
                }
            }
            return Json("");
        }
