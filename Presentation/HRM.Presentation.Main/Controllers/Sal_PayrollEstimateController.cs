...
{
    public class Sal_PayrollEstimateController : MainBaseController
    {
        readonly string _hrm_Hr_Service = ConstantPathWeb.Hrm_Hre_Service;
        readonly string _Hrm_Sys_Service = ConstantPathWeb.Hrm_Sys_Service;
        //
        // GET: /Sal_PayrollEstimate/
        public ActionResult Index()
        {
            return View();
        }

        public ActionResult Sal_PayrollEstimateConfigIfno(string id)
        {
            //bool isAccess;
        ...
        public ActionResult CreateTemplatePayrollEstimate()
        {
            return View();
        }
	}
