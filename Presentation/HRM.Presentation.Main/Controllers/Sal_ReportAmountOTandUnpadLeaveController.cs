...
{
    public class Sal_ReportAmountOTandUnpadLeaveController : MainBaseController
    {
        readonly string _hrm_Hr_Service = ConstantPathWeb.Hrm_Hre_Service;
        readonly string _Hrm_Sys_Service = ConstantPathWeb.Hrm_Sys_Service;
        //
        // GET: /Sal_ReportAmountOTandUnpadLeave/
        public ActionResult Index()
        {
            return View();
        }
        public ActionResult ReportAmountOTUnPaidLeaveConfigElementIfno(string id)
        {
            //bool isAccess;
