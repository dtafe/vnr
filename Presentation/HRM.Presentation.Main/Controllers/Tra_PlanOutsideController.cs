...
{
    public class Tra_PlanOutsideController : MainBaseController
    {
        ...
        {
            return RemoveOrDeleteAndReturn<Tra_PlanModel>(_hrm_Hr_Service, "api/Tra_Plan/", selectedIds, ConstantPermission.Tra_PlanInside, DeleteType.Remove.ToString());
        }
