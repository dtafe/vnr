...
{
    public class Eva_KPIController : MainBaseController
    {
        readonly string _Hrm_Hr_Service = ConstantPathWeb.Hrm_Hre_Service;
        public ActionResult Index()
        {
            //var isAccess = CheckPermission(UserId, PrivilegeType.View, ConstantPermission.Eva_KPI);
            //if (!isAccess)
            //{
        ...
        {
            return RemoveOrDeleteAndReturn<Eva_KPIModel>(_Hrm_Hr_Service, "api/Eva_KPI/", selectedIds, ConstantPermission.Eva_KPI, DeleteType.Remove.ToString());
        }
	}
}