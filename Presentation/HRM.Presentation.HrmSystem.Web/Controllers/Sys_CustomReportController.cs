...
{
    public class Sys_CustomReportController : BaseController
    {
        ...
        {
            var service = new RestServiceClient<Rep_MasterModel>();
        ...
        public ActionResult ConditionItemInfo(string id, Guid? MasterID)
        {
            ...
            if (!string.IsNullOrEmpty(id))
            {
                ...
                var service = new RestServiceClient<Rep_ConditionItemModel>();
