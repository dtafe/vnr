...
namespace HRM.Presentation.Hr.Models
{
       ...
       //     Guid? UserLockID { get; set; }

       //     [DataType(DataType.Date)]
       //     [DisplayFormat(DataFormatString = "{0:dd/MM/yyyy}", ApplyFormatInEditMode = true)]
       //     DateTime? DateLock { get; set; }

       //     bool? IsDelete { get; set; }

       //     [MaxLength(50)]
       //     string ServerUpdate { get; set; }

       //     [MaxLength(50)]
       //     string ServerCreate { get; set; }

       //     [MaxLength(50)]
       //     string IPCreate { get; set; }

       //     [MaxLength(50)]
       //     string IPUpdate { get; set; }
       // }
       ...
       //        this.DateLock = DateTime.UtcNow;
       //        this.DateCreate = DateTime.Now;
       //        this.DateUpdate = DateTime.Now;
       //        this.DateLock = DateTime.Now;
       //    }
