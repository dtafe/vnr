...
{
    /// <summary>Duyệt Thanh Toán Chi Phí </summary>
    public class FIN_ClaimCostPaymentApproveModel : BaseViewModel
    {
    ...
    public class FIN_ClaimCostPaymentApproveSearchModel:BaseViewSearchModel
    {
        [DisplayName(ConstantDisplay.HRM_Fin_PurchaseRequest_DateRequest)]
        public Nullable<System.DateTime> DateRequest { get; set; }
        [DisplayName(ConstantDisplay.HRM_FIN_Claim_ClaimName)]
