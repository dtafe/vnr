...
{
    public class FIN_CashAdvanceModel : BaseViewModel
    {
        ...
        public Guid? TravelRequestID { get; set; }
         [DisplayName(ConstantDisplay.HRM_FIN_CashAdvance_Other)]
    ...
    public class FIN_CashAdvanceSearchModel:BaseViewSearchModel
    {
        [DisplayName(ConstantDisplay.HRM_Fin_PurchaseRequest_DateRequest)]
        public Nullable<System.DateTime> DateRequest { get; set; }
    ...
    public class FIN_CashAdvanceMultiModel
    {
