...
{
    public class Can_ReportCardNotStandModel :BaseViewModel
    {
        ...
        [DisplayName(ConstantDisplay.HRM_Laundry_SectionName)]
        public string SectionName { get; set; }
        [DisplayName(ConstantDisplay.HRM_Canteen_Line_CateringName)]
        public string CateringName { get; set; }
        [DisplayName(ConstantDisplay.HRM_Canteen_Line_CateringName)]
        public List<Guid?> CateringID { get; set; }
        [DisplayName(ConstantDisplay.HRM_Canteen_Line_CanteenName)]
    ...
    public class Can_ReportCardNotStandSearchModel 
    {
        [DisplayName(ConstantDisplay.HRM_Attendance_ProfileName)]
