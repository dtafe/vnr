...
{
    public class CatElementModel : BaseViewModel
    {
        ...
        public string ElementLevel { get; set; }
         [DisplayName(ConstantDisplay.HRM_Category_Element_MethodPayroll)]
        ...
        public string TabType { get; set; }
         [DisplayName(ConstantDisplay.HRM_Category_GradePayroll_IsApplyGradeAll)]
         public bool? IsApplyGradeAll { get; set; }
    ...
    public class CatElementSearchModel
    {
        [DisplayName(ConstantDisplay.HRM_Category_Element_ElementName)]
        [MaxLength(200)]
        public string ElementName { get; set; }
    ...
    public class CatElementCommissionSearchModel
    {
        [DisplayName(ConstantDisplay.HRM_Category_Element_ElementName)]
        [MaxLength(200)]
        public string ElementName { get; set; }
