...
{
    public class Sal_BasicSalaryModel : BaseViewModel
    {
        ...
        public Guid? CurrencyID6 { get; set; }
        public string CurrencyName6 { get; set; }
        ...
        public string GrossAmountEncryp { get; set; }
    ...
    public class Sal_BasicSalarySearchModel
    {
