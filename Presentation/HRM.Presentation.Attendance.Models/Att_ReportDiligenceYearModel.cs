...
{
    public class Att_ReportDiligenceYearModel : BaseViewModel
    {
        ...
        [DisplayName(ConstantDisplay.HRM_Attendance_Sizes)]
        public double Sizes { get; set; }

        [DisplayName(ConstantDisplay.HRM_Attendance_Absence)]
        ...
        public partial class FieldNames
        {
            ...
            public const string DataExport = "DateExport";
