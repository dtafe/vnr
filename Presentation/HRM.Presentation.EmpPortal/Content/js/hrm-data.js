...
var convertStringToDateTime = function(_strDate)
{
    ...
    var _url = getURLMain("BasePortal/GetFormatDate/");
...
function slpitQueryEntity(queryEntityInput)
{
    ...
    debugger;
    var _url = getURLMain("BasePortal/GetUserInfo/");
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    */
    ...
    function checkPermission(privilegeType, screen, isNotify) {
        ...
        var _host = window.location.protocol + "//" + window.location.hostname + (window.location.port ? ':' + window.location.port : '') + "/";
        var _url = _host + "BasePortal/CheckPermissionAction";
        var success = false;
        $.ajax({
            url: _url,
            type: 'POST',
            ...
            success: function (result, status) {
                if (result == true) {
                    ...
                    var msg = String.format("Bạn không có quyền {0} trang này .", privilegeTranslate);
